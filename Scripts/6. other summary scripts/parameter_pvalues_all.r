...
#paths
      beta <- readRDS(local_beta_summary_path)
    growth <- readRDS(local_growth.gaus_summary_path)
recruit.AM <- readRDS(local_AM_recruitment_summary_path)
recruit.EM <- readRDS(local_EM_recruitment_summary_path)
      mort <- readRDS(local_mortality_summary_path)
      soil <- readRDS(local_soils_summary_path)
  out.path <- all_model.table_path
outCI.path <- all_model.table_CI_path
