...
output.list <- list()
output.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/nomid_east_beta_list.rds'

####SOIL C BETA FACTORS####
soil.data  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_053017_soilC.filtered.rds')
soil.pred  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_053017_soilC.summary.Rdata')
pred.range <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_053017_soilC.predictor_ranges.rds')
...
relEM.data  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_nomid_east_053017_rel.abundance.filtered.rds')
relEM.pred  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_nomid_east_053017_rel.abundance.summary.rds')
pred.range  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_nomid_east_053017_rel.abundance.ranges.rds')
...
####GROWTH BETA FACTORS####
#grab growth data
growth.data  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_051517_growth.filtered.rds')
growth.pred  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_051517_growth.summary.Rdata')
pred.range   <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_051517_growth.predictor_ranges.rds')
...
####AM RECRUITMENT####
recruitAM.data  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_AM.adult_linear_recruit.filtered.rds')
recruitAM.pred  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_AM.adult_linear_recruit.summary.Rdata')
pred.range      <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_AM.adult_linear_recruit.predictor_ranges.rds')
...
####EM RECRUITMENT####
recruitEM.data  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_EM.adult_linear_recruit.filtered.rds')
recruitEM.pred  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_EM.adult_linear_recruit.summary.Rdata')
pred.range      <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_EM.adult_linear_recruit.predictor_ranges.rds')
...
mortality.data  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_runjags_NOMID_EAST_mortality.filtered.rds')
mortality.pred  <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_runjags_NOMID_EAST_mortality.summary.Rdata')
pred.range      <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_runjags_NOMID_EAST_mortality.predictor_ranges.rds')
