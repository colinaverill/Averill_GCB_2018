...
#paths
      beta <- readRDS(local_beta_summary_path.east)
    growth <- readRDS(local_growth.gaus_summary_path.east)
recruit.AM <- readRDS(local_AM_recruitment_summary_path.east)
recruit.EM <- readRDS(local_EM_recruitment_summary_path.east)
      mort <- readRDS(local_mortality_summary_path.east)
      soil <- readRDS(local_soils_summary_path.east)
  out.path <- east_model.table_path
outCI.path <- east_model.table_CI_path
