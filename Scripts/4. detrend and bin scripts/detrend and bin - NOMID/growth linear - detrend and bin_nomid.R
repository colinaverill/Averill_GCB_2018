...
#specify paths for the Ndep prediction, the data, and the model parameter estimates. 
   model.path <- local_growth_model_path.nomid
     fit.path <- local_growth_summary_path.nomid
   range.path <- local_growth_range_path.nomid
filtered.path <- local_growth_filtered_path.nomid
    pred.path <- local_growth_prediction_path.nomid
 bins.am.path <- bins_growth_nomid_AM_path
 bins.em.path <- bins_growth_nomid_AM_path
