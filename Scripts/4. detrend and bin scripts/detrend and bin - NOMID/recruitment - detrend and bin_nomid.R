...
#set paths.
   em.model.path <- local_EM_recruitment_model_path.nomid
   am.model.path <- local_AM_recruitment_model_path.nomid
     am.fit.path <- local_AM_recruitment_summary_path.nomid
     em.fit.path <- local_EM_recruitment_summary_path.nomid
      range.path <- local_AM_recruitment_range_path.nomid
am.filtered.path <- local_AM_recruitment_filtered_path.nomid
em.filtered.path <- local_EM_recruitment_filtered_path.nomid
       bins.path <- bins_recruitment_nomid_path
...
out <- data.table(readRDS(nomid_binned_rsq_summary_path))
