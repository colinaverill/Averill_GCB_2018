...
source('required_products_utilities/master_path_list.r')
   ...
   model.path <- local_beta_model_path.nomid
     fit.path <- local_beta_summary_path.nomid
   range.path <- local_beta_range_path.nomid
filtered.path <- local_beta_filtered_path.nomid
    bins.path <- bins_beta_nomid_path
