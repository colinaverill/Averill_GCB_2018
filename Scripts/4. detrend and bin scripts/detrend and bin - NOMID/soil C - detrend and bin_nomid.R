...
#specify paths for the Ndep prediction, the data, and the model parameter estimates. 
   model.path <- local_soils_model_path.nomid
     fit.path <- local_soils_summary_path.nomid
filtered.path <- local_soils_filtered_path.nomid
    bins.path <- bins_soils_nomid_path
