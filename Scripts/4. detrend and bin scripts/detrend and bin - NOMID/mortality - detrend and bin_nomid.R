...
#specify paths.
   model.path <- local_mortality_model_path.nomid
     fit.path <- local_mortality_summary_path.nomid
   range.path <- local_mortality_range_path.nomid
filtered.path <- local_mortality_filtered_path.nomid
    bins.path <- bins_mortality_nomid_path
