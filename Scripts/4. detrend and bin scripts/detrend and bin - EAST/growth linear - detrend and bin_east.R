...
#specify paths for the Ndep prediction, the data, and the model parameter estimates. 
   model.path <- local_growth_model_path.east
     fit.path <- local_growth_summary_path.east
   range.path <- local_growth_range_path.east
filtered.path <- local_growth_filtered_path.east
    pred.path <- local_growth_prediction_path.east
 bins.am.path <- bins_growth_east_AM_path
 bins.em.path <- bins_growth_east_AM_path
