...
#specify paths for the Ndep prediction, the data, and the model parameter estimates.
   model.path <- local_growth.gaus_model_path.east
     fit.path <- local_growth.gaus_summary_path.east
   range.path <- local_growth.gaus_range_path.east
filtered.path <- local_growth.gaus_filtered_path.east
    pred.path <- local_growth.gaus_prediction_path.east
 bins.am.path <- bins_growth.gaus_east_AM_path
 bins.em.path <- bins_growth.gaus_east_EM_path
