...
source('required_products_utilities/master_path_list.r')
   ...
   model.path <- local_beta_model_path.east
     fit.path <- local_beta_summary_path.east
   range.path <- local_beta_range_path.east
filtered.path <- local_beta_filtered_path.east
    bins.path <- bins_beta_east_path
