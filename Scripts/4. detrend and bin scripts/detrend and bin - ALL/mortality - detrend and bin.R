...
#specify paths.
   model.path <- local_mortality_model_path
     fit.path <- local_mortality_summary_path
   range.path <- local_mortality_range_path
filtered.path <- local_mortality_filtered_path
    bins.path <- bins_mortality_all_path
