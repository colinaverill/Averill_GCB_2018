...
source('required_products_utilities/master_path_list.r')
   ...
   model.path <- local_beta_model_path
     fit.path <- local_beta_summary_path
   range.path <- local_beta_range_path
filtered.path <- local_beta_filtered_path
    bins.path <- bins_beta_all_path
