...
#set paths.
   em.model.path <- local_EM_recruitment_model_path
   am.model.path <- local_AM_recruitment_model_path
     am.fit.path <- local_AM_recruitment_summary_path
     em.fit.path <- local_EM_recruitment_summary_path
      range.path <- local_AM_recruitment_range_path
am.filtered.path <- local_AM_recruitment_filtered_path
em.filtered.path <- local_EM_recruitment_filtered_path
       bins.path <- bins_recruitment_all_path
