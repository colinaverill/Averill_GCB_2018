...
d <- data.table(readRDS(remote_Product_1.E.path))
...
model.path      = remote_beta_model_path.east
prediction.path = remote_beta_prediction_path.east
summary.path    = remote_beta_summary_path.east
filtered.path   = remote_beta_filtered_path.east
range.path      = remote_beta_range_path.east
