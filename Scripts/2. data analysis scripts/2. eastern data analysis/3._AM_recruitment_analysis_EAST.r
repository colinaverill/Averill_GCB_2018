...
#Save paths
model.path      = remote_AM_recruitment_model_path.east
prediction.path = remote_AM_recruitment_prediction_path.east
summary.path    = remote_AM_recruitment_summary_path.east
filtered.path   = remote_AM_recruitment_filtered_path.east
range.path      = remote_AM_recruitment_range_path.east
