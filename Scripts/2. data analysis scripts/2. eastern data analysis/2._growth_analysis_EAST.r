...
#save paths.
model.path      = remote_growth_model_path.east
prediction.path = remote_growth_prediction_path.east
summary.path    = remote_growth_summary_path.east
filtered.path   = remote_growth_filtered_path.east
range.path      = remote_growth_range_path.east
