...
library(boot)        #for inv.logit command
     ...
     am.fit.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_EAST_052617_AM.adult_EAST_linear_recruit.summary.Rdata'
     em.fit.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_EAST_052617_EM.adult_EAST_linear_recruit.summary.Rdata'
      range.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_EAST_052617_EM.adult_EAST_linear_recruit.predictor_ranges.rds'
am.filtered.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_EAST_052617_AM.adult_EAST_linear_recruit.filtered.rds'
em.filtered.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_EAST_052617_EM.adult_EAST_linear_recruit.filtered.rds'
       bins.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/east_recruit_bins.rds'
...
bins$am.detrend <- bins$recruit.am - (exp(pois.am)*inv.logit(bern.am) + 0.00001) + (exp(pois.am.m)*inv.logit(bern.am.m) + 0.00001)
bins$em.detrend <- bins$recruit.em - (exp(pois.em)*inv.logit(bern.em) + 0.00001) + (exp(pois.em.m)*inv.logit(bern.em.m) + 0.00001)
