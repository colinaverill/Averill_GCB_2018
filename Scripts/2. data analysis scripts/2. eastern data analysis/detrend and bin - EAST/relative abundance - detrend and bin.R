...
library(boot) #for inv.logit command
     ...
     fit.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_east_053017_rel.abundance.summary.rds'
   range.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_east_053017_rel.abundance.ranges.rds'
filtered.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_east_053017_rel.abundance.filtered.rds'
    bins.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/east_beta_bins.rds'
