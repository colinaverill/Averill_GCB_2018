...
#specify paths.
fit.path      <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/outputFIA7_EAST_052617_runjags_EAST_mortality.summary.Rdata'
range.path    <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_EAST_052617_runjags_EAST_mortality.predictor_ranges.rds'
filtered.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/FIA7_EAST_052617_runjags_EAST_mortality.filtered.rds'
bins.path     <- '/fs/data3/caverill/FIA7_Ndep_data.processed/east.data_analysis_output/east_mort_bins.rds'
