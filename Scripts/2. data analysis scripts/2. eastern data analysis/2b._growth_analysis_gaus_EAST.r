...
#Save paths.
model.path      = remote_growth.gaus_model_path.east
prediction.path = remote_growth.gaus_prediction_path.east
summary.path    = remote_growth.gaus_summary_path.east
filtered.path   = remote_growth.gaus_filtered_path.east
range.path      = remote_growth.gaus_range_path.east
...
inits <-list()
inits[[1]] <- list(a= -5, b = 1.7, c = 3.6, d = 3.5, e = 1.6, f = 3.3, g=3.5, h=6.8, j=3.4, k=1.0,
                   g1=8.4, g2=5.0, g3=3.9)
