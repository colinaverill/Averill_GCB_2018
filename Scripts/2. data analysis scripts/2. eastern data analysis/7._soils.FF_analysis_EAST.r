...
#specify file paths
model.path      = remote_soils.ff_model_path.east
prediction.path = remote_soils.ff_prediction_path.east
summary.path    = remote_soils.ff_summary_path.east
filtered.path   = remote_soils.ff_filtered_path.east
range.path      = remote_soils.ff_range_path.east
