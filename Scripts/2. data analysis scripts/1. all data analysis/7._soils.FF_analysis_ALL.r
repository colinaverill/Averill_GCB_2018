...
#specify file paths
model.path      = remote_soils.ff_model_path
prediction.path = remote_soils.ff_prediction_path
summary.path    = remote_soils.ff_summary_path
filtered.path   = remote_soils.ff_filtered_path
range.path      = remote_soils.ff_range_path
