...
d <- data.table(readRDS(remote_Product_1.path))
...
model.path      = remote_beta_model_path
prediction.path = remote_beta_prediction_path
summary.path    = remote_beta_summary_path
filtered.path   = remote_beta_filtered_path
range.path      = remote_beta_range_path
