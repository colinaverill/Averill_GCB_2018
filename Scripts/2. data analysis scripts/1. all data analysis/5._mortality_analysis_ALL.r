...
#specify filepaths
model.path      = remote_mortality_model_path
prediction.path = remote_mortality_prediction_path
summary.path    = remote_mortality_summary_path
filtered.path   = remote_mortality_filtered_path
range.path      = remote_mortality_range_path


#load data - subset 
#d <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/Product_2.rds')
d <- readRDS(remote_Product_2.path)
