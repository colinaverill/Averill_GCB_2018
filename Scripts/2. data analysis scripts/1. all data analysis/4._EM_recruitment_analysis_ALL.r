...
#Save paths.
model.path      = remote_EM_recruitment_model_path
prediction.path = remote_EM_recruitment_prediction_path
summary.path    = remote_EM_recruitment_summary_path
filtered.path   = remote_EM_recruitment_filtered_path
range.path      = remote_EM_recruitment_range_path
