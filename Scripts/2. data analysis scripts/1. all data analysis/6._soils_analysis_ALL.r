...
#load data - remote
d<- readRDS(remote_Product_1.path)

#specify file paths
model.path      = remote_soils_model_path
prediction.path = remote_soils_prediction_path
summary.path    = remote_soils_summary_path
filtered.path   = remote_soils_filtered_path
range.path      = remote_soils_range_path
