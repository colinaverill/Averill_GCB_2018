...
#save paths.
model.path      = remote_growth_model_path
prediction.path = remote_growth_prediction_path
summary.path    = remote_growth_summary_path
filtered.path   = remote_growth_filtered_path
range.path      = remote_growth_range_path
