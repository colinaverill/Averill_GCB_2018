...
#Save paths.
model.path      = remote_growth.gaus_model_path.nomid
prediction.path = remote_growth.gaus_prediction_path.nomid
summary.path    = remote_growth.gaus_summary_path.nomid
filtered.path   = remote_growth.gaus_filtered_path.nomid
range.path      = remote_growth.gaus_range_path.nomid


#load data - local path
#d<- readRDS(Product_3.E_nomid.path)
