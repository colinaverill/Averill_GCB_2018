...
#specify file paths
model.path      = remote_soils_model_path.nomid
prediction.path = remote_soils_prediction_path.nomid
summary.path    = remote_soils_summary_path.nomid
filtered.path   = remote_soils_filtered_path.nomid
range.path      = remote_soils_range_path.nomid
