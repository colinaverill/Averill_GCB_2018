...
#Save paths.
model.path      = remote_EM_recruitment_model_path.nomid
prediction.path = remote_EM_recruitment_prediction_path.nomid
summary.path    = remote_EM_recruitment_summary_path.nomid
filtered.path   = remote_EM_recruitment_filtered_path.nomid
range.path      = remote_EM_recruitment_range_path.nomid
