...
fit.path      <- '/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_053017_soilC.summary.Rdata'
filtered.path <- '/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_053017_soilC.filtered.rds'
bins.path     <- '/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/nomid_soil.myc_bins.rds'
