...
raw   <- readRDS(local_soils_filtered_path.east)
d     <- readRDS(local_soils_summary_path.east)
bins  <- readRDS(bins_soils_east_path)
save.path <- Supp_Figure3_all_path
rsq.table <- readRDS(east_binned_rsq_summary_path)
