...
#output file path
file.save.path <- 'Figures/nomid_east_data_figures/Supp Fig X. binned mean fits.png'

#load response curves to N-deposition with 95% credible intervals of the mean.
g.out    <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_051517_growth.summary.Rdata')
m.out    <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_runjags_NOMID_EAST_mortality.summary.Rdata')
r.out.am <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_AM.adult_linear_recruit.summary.Rdata')
r.out.em <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_NOMID_EAST_052617_EM.adult_linear_recruit.summary.Rdata')
b.out    <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/FIA7_nomid_east_053017_rel.abundance.summary.rds')
...
b.bins    <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/nomid_beta_bins.rds')
g.bins.am <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/nomid_growth.am_bins.rds')
g.bins.em <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/nomid_growth.em_bins.rds')
r.bins    <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/nomid_recruit_bins.rds')
m.bins    <- readRDS('/fs/data3/caverill/FIA7_Ndep_data.processed/nomid_east.data_analysis_output/nomid_mort_bins.rds')
